<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageLogins.aspx.cs" Inherits="VotingApp.Account.ManageLogins" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" Text="Usuń" CommandName="Delete" CausesValidation="false"
                                ToolTip='<%# "Usuń to " + Item.LoginProvider + " logowanie ze swojego konta" %>'
